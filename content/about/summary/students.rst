...
have worked on, check out our `student stories </students/stories>`_.

`Open Source on Campus </students/oss_at_osu/>`_
------------------------------------------------
The OSU Open Source Lab is not the only location on campus where students are
exposed to open source software and practices. The `Open Source Education Lab
<http://osel.oregonstate.edu>`_ and `Linux User Group
<http://lug.oregonstate.edu>`_ are both very active on campus and give students
...
more, please see `Open Source at OSU </students/oss_at_osu/>`_.
