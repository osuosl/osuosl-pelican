...
.. raw:: html
    ...
    <div id="content">
      ...
      <form class="webform-client-form" enctype="multipart/form-data" action="/services/powerdev/request_hosting" method="post" id="webform-client-form-1086" accept-charset="UTF-8">
        <div>
          ...
          <div class="form-item webform-component webform-component-textfield" id="webform-component-project-name">
            ...
            <input type="text" id="edit-submitted-project-name" name="submitted[project_name]" value="" size="60" maxlength="128" class="form-text required" />
          ...
          <div class="form-item webform-component webform-component-textfield" id="webform-component-community-size">
            ...
            <input type="text" id="edit-submitted-community-size" name="submitted[community_size]" value="" size="60" maxlength="128" class="form-text required" />
          ...
          <div class="form-item webform-component webform-component-textarea" id="webform-component-mission">
            ...
            <div class="form-textarea-wrapper resizable"><textarea id="edit-submitted-mission" name="submitted[mission]" cols="60" rows="5" class="form-textarea required"></textarea></div>
          ...
          <div class="form-item webform-component webform-component-textarea" id="webform-component-usage">
            ...
            <div class="form-textarea-wrapper resizable"><textarea id="edit-submitted-usage" name="submitted[usage]" cols="60" rows="5" class="form-textarea required"></textarea></div>
          ...
          <div class="form-item webform-component webform-component-textfield" id="webform-component-duration">
            ...
            <input type="text" id="edit-submitted-duration" name="submitted[duration]" value="" size="60" maxlength="128" class="form-text required" />
          ...
          <div class="form-item webform-component webform-component-select" id="webform-component-power-architecture">
            ...
            <select id="edit-submitted-power-architecture" name="submitted[power_architecture]" class="form-select required">
              <option value="" selected="selected">- Select -</option>
              <option value="ppc64 POWER7">ppc64 POWER7</option>
              <option value="ppc64_power8">ppc64 POWER8 (Big Endian)</option>
              <option value="ppc64le POWER8">ppc64le POWER8 (Little Endian)</option>
            </select>
          </div>
          <div class="form-item webform-component webform-component-select" id="webform-component-flavor">
            ...
            <select id="edit-submitted-flavor" name="submitted[flavor]" class="form-select required">
              <option value="" selected="selected">- Select -</option>
          ...
          <div class="form-item webform-component webform-component-number" id="webform-component-num-nodes">
            ...
            <input type="number" id="edit-submitted-num-nodes" name="submitted[num_nodes]" value="1" min="1" step="any" class="form-text form-number required" />
          ...
          <div class="form-item webform-component webform-component-select" id="webform-component-distribution">
            ...
            <select id="edit-submitted-distribution" name="submitted[distribution]" class="form-select required">
              <option value="" selected="selected">- Select -</option>
          ...
          <div class="form-item webform-component webform-component-select" id="webform-component-openstack-access">
            ...
            <select id="edit-submitted-openstack-access" name="submitted[openstack_access]" class="form-select">
              <option value="" selected="selected">- None -</option>
              <option value="osl_create">Have the OSL create the node(s) for me</option>
              <option value="openstack_access">I&#039;d like to have access to the Openstack GUI/API</option>
            </select>
          ...
          <div class="form-item webform-component webform-component-textarea" id="webform-component-ssh-key">
            ...
            <div class="form-textarea-wrapper resizable"><textarea id="edit-submitted-ssh-key" name="submitted[ssh_key]" cols="60" rows="5" class="form-textarea required"></textarea></div>
          ...
          <div class="form-item webform-component webform-component-textfield" id="webform-component-ibm-ltc-advocate">
            ...
            <input type="text" id="edit-submitted-ibm-ltc-advocate" name="submitted[ibm_ltc_advocate]" value="" size="60" maxlength="128" class="form-text required" />
          ...
          <div class="form-item webform-component webform-component-select" id="webform-component-deployment-timeframe">
            ...
            <select id="edit-submitted-deployment-timeframe" name="submitted[deployment_timeframe]" class="form-select">
              <option value="7_days" selected="selected">Within 7 business Days</option>
              <option value="3_days">Within 3 business Days</option>
              <option value="1_day">Within 1 business Day</option>
            </select>
          ...
          <div class="form-item webform-component webform-component-textarea" id="webform-component-other-information">
            ...
            <div class="form-textarea-wrapper resizable"><textarea id="edit-submitted-other-information" name="submitted[other_information]" cols="60" rows="5" class="form-textarea"></textarea></div>
          ...
          <input type="hidden" name="form_build_id" value="form-xemInGbDQZ8ti0xGOYSbM8Z94ijOOAKLXPIOfDRFHPA" />
